...
- Some terms in this document refer to concepts that are planned updates that do not currently exist in the codebase, including:
  - the supersaw waveform
  - MIDI
  - effects: pan, delay, reverb, distortion, bitcrusher
